...
**Sequence:**
1. **WAIT** - Cross-model reviews land
2. **SYNTH** - Triangulate (Claude review + review 2 + review 3) into durable file
3. **FIX** - Batch confirmed issues, per branch
4. **GATE** - Re-gate all branches, update checklist
5. **WALK** - Operator walkthrough on fixed code, mark human checks
6. **COMPARE** - Human findings vs model findings produces governance signal
