...
| SD-131 | **"Going light" -- Captain considering making docs/internal/ public.** "What the fuck am I trying to hide? It's a circus act. I'm done with that. I'm interested in real engineering, finding a cool job and trying to find the truth. Thats it. Hang me." Security sweep: 69/71 files clean. 2 files need 8 redactions (Stripe session ID, Clerk user ID, personal email, LinkedIn URL) -- both copies of the already-flagged QA doc. Removes the concept of attack surface entirely. SD-102 (deferred mass plank walk) superseded -- not scrubbing, revealing. SD-103 (git archaeology threat) neutralised -- nothing to find because everything is visible. Verbatim at `docs/internal/main-thread/2026-02-25-002-going-light.md` (444). Awaiting Captain's decision. | Captain (consideration) / Weaver (analysis) | Pending -- Captain's call |
