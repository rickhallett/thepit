...
# e5f6a7b HEAD@{1}: commit: the commit you want back
# c3d4e5f HEAD@{2}: commit: another lost commit
# ...
...
**Step 8: Process Observation** (`08-process-observation.md`) - now that you can verify
