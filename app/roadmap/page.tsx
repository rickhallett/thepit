...
const LANES: Lane[] = [
  {
    ...
    items: [
      ...
      { label: 'Vercel AI Gateway (BYOK)', status: 'done', detail: 'BYOK users choose any LLM via OpenRouter multi-provider routing' },
      { label: 'Multi-model routing', status: 'done', detail: 'Per-agent model selection in custom arena builder' },
