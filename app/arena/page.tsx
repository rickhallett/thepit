...
export const metadata = {
  title: 'Arena — THE PIT',
  description: 'Pick your preset. Watch AI personas clash in real-time debates.',
};
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col gap-12 px-6 py-12">
        <header className="flex flex-col gap-5 border-b-2 border-foreground/70 pb-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <Link 
              href="/"
              className="text-xs uppercase tracking-[0.4em] text-accent transition hover:text-accent/80"
            >
              THE PIT
            </Link>
            <AuthControls />
          ...
          <p className="max-w-2xl text-sm text-muted">
            ...
            each agent in real time. No scripts. No safety nets. Just chaos.
          </p>
        ...
        <footer className="flex flex-wrap items-center justify-between gap-4 border-t-2 border-foreground/70 pt-8 text-xs uppercase tracking-[0.3em] text-muted">
          <span>Zero monte carlo. Zero equity. Pure spectacle.</span>
