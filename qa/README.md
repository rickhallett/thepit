...
# Optional: set a custom password (default: QaTest123!)
export QA_TEST_PASSWORD="your-secure-password"
...
|---------|-------|------|---------|
| `standard` | qa-free@thepit.test | free | 500 |
| `premium` | qa-premium@thepit.test | pit_pass | 1000 |
| `exhausted` | qa-exhausted@thepit.test | free | 0 |
...
QA_TEST_PASSWORD=QaTest123!

# Test accounts (generated by pnpm run qa:setup)
QA_TEST_USER_EMAIL=qa-free@thepit.test
QA_TEST_USER_ID=user_2abc...

QA_PREMIUM_USER_EMAIL=qa-premium@thepit.test
QA_PREMIUM_USER_ID=user_2def...

QA_EXHAUSTED_USER_EMAIL=qa-exhausted@thepit.test
