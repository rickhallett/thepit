// GENERATED by `drizzle-kit introspect` — DO NOT EDIT MANUALLY.
// The authoritative schema is db/schema.ts. This file may be out of sync
// with the source schema. Regenerate with: pnpm drizzle-kit introspect
