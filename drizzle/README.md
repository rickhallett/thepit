...
| 0003 | `messy_chat` | Feb 11, 2026 | Community tables: `feature_requests`, `feature_request_votes`, `paper_submissions` with indexes |
| 0004 | `analytics-and-pending-tables` | Feb 12, 2026 | Analytics + pending tables: `page_views`, `short_links`, `short_link_clicks` (with FK), `remix_events`, `research_exports` |
| 0005 | `add_foreign_keys` | Feb 12, 2026 | Add foreign key constraints across all tables |
| 0006 | `page-views-utm-fields` | Feb 13, 2026 | UTM tracking fields on `page_views` |
| 0007 | `bouts-status-index` | Feb 13, 2026 | Performance index on `bouts.status` |
| 0008 | `page-views-copy-variant` | Feb 15, 2026 | Copy A/B test variant tracking on `page_views` |
...
├── 0003_messy_chat.sql
├── 0004_analytics-and-pending-tables.sql
├── 0005_add_foreign_keys.sql
├── 0006_page-views-utm-fields.sql
├── 0007_bouts-status-index.sql
├── 0008_page-views-copy-variant.sql
└── meta/
    ...
    ├── 0003_snapshot.json     Schema snapshot after migration 3
    └── 0004_snapshot.json     Schema snapshot after migration 4
```
